  ...
  return (
    <div className="container">
      <div className="card" style={{ maxWidth: '600px', margin: '40px auto' }}>
        <h1 className="text-center mb-md" style={{ color: 'var(--primary-color)' }}>Support</h1>
        ...
        <div className="mt-lg" style={{ color: 'var(--text-secondary-light)', fontSize: 'var(--font-sm)' }}>
